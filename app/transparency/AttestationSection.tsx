...
export function AttestationSection() {
  return (
    <section className="attestation-placeholder">
      <h2 className="caps slot-title">Reserve attestations</h2>
      <div className="empty-state">
        On-chain attestation reporting is in preparation. When attestations
        are published, they will appear here, on schedule and without a
        login.
      </div>
    </section>
  );
